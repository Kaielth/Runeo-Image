...
<table>
	...
	<tr>
		<td colspan="3">
			...
			<?php echo form_label('Recordarme', $remember['id']); ?> <br>
			<?php echo anchor('/recuperar-password/', 'Recordar contraseña'); ?> <br>
			<?php if ($this->config->item('allow_registration', 'tank_auth')) echo anchor('/registrar/', 'Nueva cuenta'); ?>
		</td>
	</tr>
</table>
